 ...
 * that are present in GmsCore which need to be transformed from
 * "com.google…" to the ReVanced GmsCore package
 * ("app.revanced.android.gms") so the patched app binds to microG
 * instead of the real Google Play Services.
 *
 * Ported from MorpheApp/morphe-patches via hoo-dles/morphe-patches
 * (patches/all/microg/Constants.kt).
 */

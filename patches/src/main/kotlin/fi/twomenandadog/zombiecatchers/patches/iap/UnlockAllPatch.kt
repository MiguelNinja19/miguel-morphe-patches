...
val unlockAllPatch = rawResourcePatch(
    ...
    description = "Hex patches libcocos2dcpp.so to bypass Play Store " +
        "redirect and set unlimited currencies. Pure native patching.",
    default = true,
) {
    ...
    execute {
        ...
        // Patterns extracted from ACTUAL binary bytes (no trailing zeros!)
        // Each pattern is unique (1 occurrence in 24MB binary)
        val patches = listOf(
            Triple(

...
> **[v1.3.6](https://github.com/MiguelNinja19/miguel-morphe-patches/releases/tag/v1.3.6)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;2 patches total
<details open>
...
|----------|----------------|-----------|
| [Free in-app purchases](#free-in-app-purchases) | Skips Google Play Billing and credits IAP items (gem packs, coin packs, starter packs) directly. Uses UI thread + delay to properly close the Contacting screen. Also disables the startup purchase-restore flow. |  |

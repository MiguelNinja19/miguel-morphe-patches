...
> **[v1.6.5](https://github.com/MiguelNinja19/miguel-morphe-patches/releases/tag/v1.6.5)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;7 patches total
<details open>
...
| [Unlimited gems, keys & unlock all](#unlimited-gems-keys-unlock-all) | Sets gems to 9999999, keys to 9999999, unlocks VIP (removes ads) and all assassin characters (2-35) by writing directly to the game's SharedPreferences on app resume. |  |
